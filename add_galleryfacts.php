...
if(isset($_POST['edit'])){
    ...
    $sql_add = 'INSERT into facts (text, url) VALUES (?, ?)';
    $stmt_add = mysqli_prepare($conn, $sql_add);
    mysqli_stmt_bind_param($stmt_add, "ss", $string, $img);
                ...
                <div class="edit-news">
                    ...
                    <form method="post">
                        <form method="post">
                            ...
                            <input type="text" id="img" name="img" placeholder="Link of the image. Ex: img/image.jpg.">
                            <label for="text">Text:</label>
                            <input type="text" id="add-text" name="text" placeholder="Text here.">
