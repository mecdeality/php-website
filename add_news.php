...
if(isset($_POST['add'])){
    ...
    $cat = $_POST['cat'];
    if(empty($title) || empty($img1) || empty($img2) || empty($text)){
        $wrong = "All fields must be filled!";
    }
    $sql_add = 'INSERT INTO news (title, text, categorie_id, img1, img2) VALUES ("'.$title.'","'.$text.'","'.$cat.'","'.$img1.'","'.$img2.'")';
    $run = mysqli_query($conn, $sql_add);
    header("Location: index.php");


//    if($class->Execute($sql_add)){
//        header("Location:index_admin.php");
//    }else{
//        echo "ERROR";
//        echo mysqli_error($class->Execute($sql_add));
//    }
}
                    ...
                    <form method="post">
                        <form method="post">
                            ...
                            <div class="title-categorie">
                                <input id="add-title" type="text" name="title" placeholder="Title of the news.">
                                <select id="categories" name="cat">
                                    <option value="cat">Category</option>
                                    <?php
                                    $run_categories = mysqli_query($conn, "SELECT * FROM categories WHERE id NOT IN(7)");
                            ...
                            <input type="text" id="img1" name="img1" placeholder="Link of the preview image. Ex: img/image.jpg.">
                            <label for="img2">Image:</label>
                            <input type="text" id="img2" name="img2" placeholder="Link of the image. Ex: img/image.jpg.">
                            <label for="text">Text:</label>
                            <textarea id="add-text" name="text" cols="30" rows="13" placeholder="Text here."></textarea>
                            <h6 style="font-family: Noto Serif; color: red;" id="wrong"></h6>
